...
export const CONFIG = {
    colors: {
        ...
        buy: 'rgba(14, 203, 129, 0.3)',    // зелёный полупрозрачный
        sell: 'rgba(246, 70, 93, 0.3)',    // красный полупрозрачный
        border: '#ffd700',
        long: 'rgba(246, 70, 93, 0.4)',    // красный для лонгов
        short: 'rgba(14, 203, 129, 0.4)',  // зелёный для шортов
        border: '#ff6b6b'
    },
    ...
    indicators: [
        ...
        { type: 'ema9',  label: 'EMA 9',  defaultParams: { period: 9 },  color: '#FFD700', scale: 'right' },
        { type: 'ema20', label: 'EMA 20', defaultParams: { period: 20 }, color: '#00E5FF', scale: 'right' },
        { type: 'ema50', label: 'EMA 50', defaultParams: { period: 50 }, color: '#FF69B4', scale: 'right' },
        { type: 'ema100', label: 'EMA 100', defaultParams: { period: 100 }, color: '#200dc8', scale: 'right' },
        { type: 'ema200', label: 'EMA 200', defaultParams: { period: 200 }, color: '#891694', scale: 'right' },
