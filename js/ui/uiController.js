...
document.getElementById('volumeProfileBtn')?.addEventListener('click', () => {
    this.drawingManager.setDrawingMode('volumeProfile');
    this.setActiveDrawBtn('volumeProfile');
});
    ...
    setActiveDrawBtn(mode) {
        ...
        else if (mode === 'volumeProfile') document.getElementById('volumeProfileBtn').classList.add('active');
